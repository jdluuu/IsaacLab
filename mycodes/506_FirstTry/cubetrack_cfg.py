...
CubeTrack_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/jiadong/CubeTrack_Isaac/509_NoBelts/CubeTrackV2_Nobelts.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.15), joint_pos={"lf_wheel_joint": 0.0, "lh_wheel_joint": 0.0, "rf_wheel_joint": 0.0, "rh_wheel_joint": 0.0, "Flipper_to_L_QsETM_Verti":0.0, "Flipper_to_R_QsETM_Verti":0.0}
    ),
    actuators={
